...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BUTTERFREE] =
    {
        ...
        .baseDefense   = 70,
        .baseSpeed     = 100,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_6 ? 90 : 90,
        .baseSpDefense = 90,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TINTED_LENS, ABILITY_NONE, ABILITY_GHOSTLY_SCALES },
    ...
    [SPECIES_BUTTERFREE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_GHOSTLY_SCALES, ABILITY_GHOSTLY_SCALES, ABILITY_GHOSTLY_SCALES },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Butterfree"),
        .cryId = CRY_BUTTERFREE,
        .natDexNum = NATIONAL_DEX_BUTTERFREE,
        ...
        .description = COMPOUND_STRING(
            ...
            "ghostly chamber that couldn't\n"
            "escape, it finishes them off with\n"
            "its ghostly scales."),
        .pokemonScale = 366,
        .pokemonOffset = 2,
        .trainerScale = 256,
...
#define BEEDRILL_ATTACK (P_UPDATED_STATS >= GEN_6 ? 110 : 110)
    ...
    [SPECIES_BEEDRILL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_IMMUNITY, ABILITY_NONE, ABILITY_SUPER_LUCK},
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_PIDGEY] =
    {
        ...
        .abilities = { ABILITY_POWER_SPOT, ABILITY_POWER_SPOT, ABILITY_NO_GUARD },
    #else
        .abilities = { ABILITY_POWER_SPOT, ABILITY_POWER_SPOT, ABILITY_NO_GUARD },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 111 : 111)
    ...
    [SPECIES_RATTATA] =
    {
        ...
        .abilities = { ABILITY_MOXIE, ABILITY_GUTS, ABILITY_QUICK_FEET },
    ...
    [SPECIES_RATTATA_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GUTS, ABILITY_MOXIE, ABILITY_MOLD_BREAKER },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Rattata"),
        .cryId = CRY_RATTATA,
        .natDexNum = NATIONAL_DEX_RATTATA,
...
#define DUGTRIO_ATTACK (P_UPDATED_STATS >= GEN_7 ? 100 : 80)
    ...
    [SPECIES_KADABRA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_ALAKAZAM}),
    },
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_DRATINI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_MARVEL_SCALE, ABILITY_MARVEL_SCALE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DRAGONAIR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_DRAGONITE}),
    },
